 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(/* code here */inventory) {
  /* code here */
  const theInfo = inventory.find((item, index) => {
    return index === 0
  })
  return `This is a ${theInfo.car_make} ${theInfo.car_model}`
}
